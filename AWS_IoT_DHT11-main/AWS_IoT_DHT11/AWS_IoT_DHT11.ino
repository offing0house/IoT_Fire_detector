...
void getDeviceStatus(char* payload) {
  ...
  sprintf(payload,"{\"state\":{\"reported\":{\"temperature\":\"%0.2f\",\"LED\":\"%s\",\"count\":\"%d\"}}}",t,led,event_count);
}
...
void onMessageReceived(int messageSize) {
  ...
  if (strcmp(led,"ON")==0) {
    led1.on();
    sprintf(payload,"{\"state\":{\"reported\":{\"LED\":\"%s\",\"count\":\"%d\"}}}","ON",event_count);
    sendMessage(payload);
    
  } else if (strcmp(led,"OFF")==0) {
    led1.off();
    sprintf(payload,"{\"state\":{\"reported\":{\"LED\":\"%s\",\"count\":\"%d\"}}}","OFF",event_count);
    sendMessage(payload);
  }
